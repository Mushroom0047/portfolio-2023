...
export const WordPressProjects = [
    ...
    },
    {
        ...
        desc: "Sitio web para inmobiliario ISudamericana, desarrollado en WordPress con Elementor.",
        urlImg: urlImg  + "fotos portafolio hector valdes m _ Inmobiliaria sudamericana.webp",
        link: "#",
    },
    {
        title: "Tienda de servicios",
        desc: "Sitio web sobre venta de servicios de desarrollo llamada Necesito Web, desarrollado en WordPress con Elementor y Woocommerce.",
        urlImg: urlImg  + "fotos portafolio hector valdes m _ Necesito Web.webp",
